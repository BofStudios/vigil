        ...
        ? { needed: true, provider: "groq", reason: "", host: "http://localhost:11434",
            routes: [
              ...
              { key: "anthropic", name: "Claude", badge: "your key", needs_key: true,
                ...
                placeholder: "sk-ant-..." },
              { key: "openai", name: "GPT", badge: "your key", needs_key: true,
                blurb: "Your own OpenAI key. Vigil is the harness, not the model - when a lab ships something better at driving a computer, you run it in here, behind the same approvals and the same blocked actions.",
                models: [{ id: "gpt-6-astra", note: "Strongest at driving a computer (default)" },
                         { id: "gpt-5.2", note: "Cheaper, still calls tools well" },
                         { id: "gpt-5.2-mini", note: "Fast and cheap" }],
                link: "https://platform.openai.com/api-keys", link_text: "Get an OpenAI key",
                placeholder: "sk-..." },
